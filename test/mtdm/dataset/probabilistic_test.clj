(ns mtdm.dataset.probabilistic-test
  (:use midje.sweet)
  (:require
   [mtdm.dataset.probabilistic :as probabilistic]
   [mtdm.dataset.base :refer [get-dataset-id-map]]
   [mtdm.utils :refer [percent map-vals]]))
