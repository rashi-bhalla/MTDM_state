(defproject mtdm "0.1.0-SNAPSHOT"
  :description "Minimized Tree for Distributed Mining: A Distributed Data Mining Approach to Classifying Heterogeneous Data Streams"
